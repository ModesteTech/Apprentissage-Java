...
# ▶️ Exécution d'un programme
Depuis un terminal, à l'intérieur du dossier concerné :
javac NomDuFichier.java
java NomDuFichier
# 👤 Auteur
Modeste — Étudiant en 2ème année à l'ENSPY
GitHub : @ModesteTech
Dépôt en évolution constante au fil de ma progression.
